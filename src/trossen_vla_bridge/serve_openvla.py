...
def main() -> None:
    ...
    parser.add_argument(
        "--checkpoint",
        default="UoA-Trossen-Arm/openvla-7b-trossen-pnp-4diverse-wrist-png",
        help="HF repo id or local checkpoint dir",
    )
    parser.add_argument("--image-key", default="cam_wrist")
    parser.add_argument("--unnorm-key", default="pnp_4diverse_png_wrist")
